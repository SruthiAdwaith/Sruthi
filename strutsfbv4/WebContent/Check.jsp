...
<br>
    <div class="col-md-7" STYLE="margin-left:180px"class="navbar-header"  STYLE="BACKGROUND: #3b5998 ">
      ...
      <input type="button" type="submit"STYLE="height:25px; width:80px;margin-left:20px" class=" from-group form-inline btn btn-success" id="ad" value="Sign Up"> 
