...
<br>
    <div class="col-md-7" STYLE="margin-left:180px"class="navbar-header"  STYLE="BACKGROUND: #3b5998 ">
      ...
      <input type="button" STYLE="height:25px; width:80px;margin-left:20px" class="form-group green_btn" id="ad" class="form-inline" class="form-group"class="btn btn-primary" value="Sign Up"> 
...
<form>
 ...
 <input class="form-control input-lg" STYLE="height:25px; width:270px" id="inputlg" type="text" name="emailnum"  placeholder=" Mobile number or e-mail address">
