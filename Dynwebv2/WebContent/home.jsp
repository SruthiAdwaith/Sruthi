...
$("#avail").on('click',function(){
  ...
  $.ajax({
	...
	success: function(data) {
        ...
        String ur=data[0].vchr_prof_pic;
        String fn=data[0].vchr_first_name;
        String ln=data[0].vchr_last_name;
        
	
        if (data[0].ResponseCode == 200) {
        	var ema=$("#email").val();
        	alert(ema);
        			//var url= "success.jsp?fin=" + fn + "&lan="+ ln + "&uar=" +ur ;
        	 window.location.href="success.jsp?fin"= + fn + "&lan="+ ln + "&uar="+ur" ;
        }
        ...
        window.location.href = 'Check.jsp';
        	...
        	alert(ema);
        	 ...
        	 window.location.href="psw.jsp?fin"= + fn + "&lan="+ ln + "&uar="+ur";
...
<font size="4">Birthday:</font><br><br>
 ...
 <select style="margin-left:20px;"name="Month" >
